...
<table style="width:100%; border-collapse: collapse; border: 1px solid black;">
  <thead>
    <tr style="border-bottom: 2px solid black;">
      <th style="border-bottom: 1px solid black; padding: 8px;">Feature</th>
      <th style="border-bottom: 1px solid black; padding: 8px;">NN</th>
      <th style="border-bottom: 1px solid black; padding: 8px;">CNN</th>
      <th style="border-bottom: 1px solid black; padding: 8px;">RNN</th>
    </tr>
  </thead>
  <tbody>
