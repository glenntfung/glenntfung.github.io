...
> ##### TIP
>
> To ensure the TikZ graphs render clearly, please use light mode. 
{: .block-tip }
...
LSTMs are a special type of RNN that use **gates** to control the flow of information. These gates help the network decide which information to remember, forget, or output at each time step, enabling LSTMs to capture long-term dependencies effectively.
