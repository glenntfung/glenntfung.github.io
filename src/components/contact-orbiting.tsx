...
import { Mail, Linkedin, Github, Calendar as CalendarIcon } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full">
        ...
        >
          {/* Inner orbit - Email circles (no icons) */}
          <OrbitingCircles radius={80} duration={0} />
          
          {/* Outer orbit - Social circles (no icons) */}
          <OrbitingCircles radius={140} reverse duration={0} />
