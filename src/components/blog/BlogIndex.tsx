          ...
          <article key={post.slug} className="group signature-hover">
            <div className="flex items-baseline justify-between gap-3 mb-2">
              <h2 className="text-xl font-semibold">
                <Link href={`${post.href}/`} className="text-primary group-hover:text-accent transition-colors">
                  {post.title}
                </Link>
              </h2>
              <time dateTime={post.date} className="text-xs text-neutral-500 dark:text-neutral-600 whitespace-nowrap">
