...
const countryData: { [key: string]: { name: string; category: string } } = {
  ...
  "TUR": { name: "Turkey", category: "Europe/Asia" },
  "RUS": { name: "Russia", category: "Europe/Asia" },
              ...
              <div className="text-center space-y-3">
                {(() => {
                  ...
                  visitedCountries.forEach(countryCode => {
                    ...
                    // Only add if we have data for it
                    if (countryData[countryCode]) {
                        categories[category].push(countryData[countryCode].name);
                    }
                  });
